...
namespace ArtGallery_ECommerce.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ProductSize = new SelectList(db.ProductSize, "ProductSizeId", "Size");
        ...
        public ActionResult Create([Bind(Include = "ProductId,Name,Artist,Price,InStock,Description,ProductSizeId,CategoryId")] Products products)
        {
